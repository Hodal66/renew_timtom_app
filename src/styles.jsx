export const genStyle={
   bg_blueLinearGradient : "bg-blue-500",
   text_bg_gradient : "bg-gradient-text bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500",
}
...
export const styles = {
   ...
   flexRowCenter:"flex items-center gap-4",
   flexCol:"flex flex-col gap-4",
   paddingX: "sm:px-16 px-6",
   paddingY: "sm:py-16 py-6",
   overlaySlow:"absolute inset-0 bg-gradient-to-t from-bg-dark-900  via-dark-500 to-bg-dark-100",
   ...
   mainPaddingX:"px-8 md:px-32",
   mainPaddingy:"py-24 md:py-32",
 ...
 export const icons = [
   <ion-icon name="arrow-forward-circle-outline" key={"0"}></ion-icon>,
   <ion-icon name="arrow-undo-circle-outline"  key={"1"}></ion-icon>,
   <ion-icon name="navigate-outline"  key={"2"}></ion-icon>,
 ];
